    ...
    deselect: (cb) ->
        if @selected
            ...
            if @parent
                ...
                @p_hoverset.animate {transform: "...T0,#{@grow_translate}"}, o.ungrow_speed, ">", post_animation
                @p_stem.animate {path: "M#{@parent.center_xy[0]},#{@parent.center_xy[1]}L#{@orig_center_xy[0]},#{@orig_center_xy[1]}"}, o.ungrow_speed, ">"
                @grow_translate = 0
